...
import 'package:terminal_library/xterm_library/core/ui/painter.dart';
import 'package:terminal_library/xterm_library/core/ui/selection_mode.dart';
import 'package:terminal_library/xterm_library/core/ui/terminal_size.dart';
...
class RenderTerminalLibraryFlutter extends RenderBox
  ...
  void selectCharacters(Offset from, [Offset? to]) {
    ...
    selectCharactersFromCells(fromPosition, toPosition);
  }

  /// Select characters using buffer cell offsets. This keeps the anchor stable
  /// even if the viewport scrolls while dragging.
