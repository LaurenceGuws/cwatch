...
import 'package:terminal_library/xterm_library/core/ui/palette_builder.dart';
// Paragraph cache removed in patched build (dependency not bundled)
...
class TerminalLibraryFlutterPainter {
  ...
  // Paragraph cache removed (dependency not bundled).
  ...
  void paintCellForeground(Canvas canvas, Offset offset, CellData cellData) {
    ...
    final builder = ParagraphBuilder(
      ParagraphStyle(fontSize: style.fontSize, height: style.height),
