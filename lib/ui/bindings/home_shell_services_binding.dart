...
import 'package:cwatch/app/adapters/ssh_auth_prompter.dart';
import 'package:cwatch/core/navigation/home_shell_services.dart';
...
import 'package:cwatch/services/window/tray_service.dart';
import 'package:cwatch/services/window/window_chrome_service.dart';
import 'package:cwatch/core/navigation/gesture_detector_factory.dart';
...
class HomeShellServicesBinding {
  ...
  SshAuthCoordinator createAuthCoordinator({
    ...
    return SshAuthPrompter.forContext(
      context: context,
