...
class _ProcessTreeViewState extends State<ProcessTreeView> {
  ...
  void _handleSort(ProcessSortColumn column) {
    setState(() {
      if (_sortColumn == column) {
        ...
        _sortColumn = column;
        _sortAscending = column == ProcessSortColumn.command ||
  ...
  List<ProcessTreeRowData> _buildProcessRowData(
    ...
    final nodes = {
      for (final info in processes) info.pid: ProcessNode(info),
    };
