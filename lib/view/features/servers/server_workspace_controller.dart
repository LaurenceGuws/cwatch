...
import 'server_workspace_tab_restorer.dart';
...
class ServerWorkspaceController extends TabbedWorkspaceController {
  ...
  final ServerWorkspaceTabRestorer _tabRestorer =
  ...
  Future<void> restore({
    ...
    for (final tabState in workspace.tabs) {
      final host = _tabRestorer.resolveHost(tabState, hosts);
      if (host == null) continue;

      final tab = _tabRestorer.restoreTab(
        state: tabState,
        host: host,
