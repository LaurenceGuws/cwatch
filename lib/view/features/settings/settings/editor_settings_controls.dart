...
class EditorSettingsControls extends StatefulWidget {
  ...
  @override
  State<EditorSettingsControls> createState() => _EditorSettingsControlsState();
}

class _EditorSettingsControlsState extends State<EditorSettingsControls> {
  ...
  @override
  void didUpdateWidget(covariant EditorSettingsControls oldWidget) {
