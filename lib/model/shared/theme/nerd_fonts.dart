...
class NerdFonts {
  ...
  // Dedicated mono family for terminal text metrics (same family for simplicity).
  static const String terminalFamily = family;
...
const Map<NerdIcon, IconData> nerdIconData = {
  ...
  NerdIcon.penguin: IconData(0xf0ec0, fontFamily: NerdFonts.family),
