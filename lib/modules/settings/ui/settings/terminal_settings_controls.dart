...
class TerminalSettingsControls extends StatefulWidget {
  ...
  @override
  State<TerminalSettingsControls> createState() =>
      _TerminalSettingsControlsState();
}

class _TerminalSettingsControlsState extends State<TerminalSettingsControls> {
  ...
  @override
  void didUpdateWidget(covariant TerminalSettingsControls oldWidget) {
